...
/**
 * A ward as served by ward-service, used to validate a ward before scheduling.
 * 
 * This is a local copy of the Ward record used by the staffing-service.
 ...
 * 
 * The fields match the Ward record from ward-service exactly:
